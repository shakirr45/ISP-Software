<?php
$bsuppliers = $obj->view_all('suppliers');
$bproducts = $obj->raw_sql("SELECT * FROM products WHERE deleted_at IS NULL");
?>
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-wizard">
                <fieldset class="wizard-fieldset show">
                    <h6 class="text-md text-neutral-500">Supplier Return List</h6>
                    <div class="row gy-3">
                        <div class="col-sm-3">
                            ...
                            <div class="position-relative">
                                <select id="supplier-filter" class="form-control">
                                    ...
                                    <?php foreach ($bsuppliers as $supplier): ?>
...
<div class="card basic-data-table">
    <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
        <h5 class="text-md text-neutral-500">Supplier Return Product List</h5>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#supplier-filter,#product-filter, #date-from, #date-to').on('change', function() {
            table.ajax.reload();
        });
    });
</script>
