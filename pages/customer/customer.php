...
// ========================================= start ====================
$totalActiveCustomers = $obj->rawSqlSingle("SELECT COUNT(*) AS total FROM tbl_agent WHERE ag_status = 1");
$totalInactiveCustomers = $obj->rawSqlSingle("SELECT COUNT(*) AS total FROM tbl_agent WHERE ag_status = 0");
// =========================================  end ================
...
$totalCustomers = $obj->rawSqlSingle("SELECT COUNT(*) AS total FROM tbl_agent WHERE deleted_at IS NULL");
$activeCustomers = $obj->rawSqlSingle("SELECT COUNT(*) AS total FROM tbl_agent WHERE ag_status = 1 AND deleted_at IS NULL");
$inactiveCustomers = $obj->rawSqlSingle("SELECT COUNT(*) AS total FROM tbl_agent WHERE ag_status = 0 AND deleted_at IS NULL");
